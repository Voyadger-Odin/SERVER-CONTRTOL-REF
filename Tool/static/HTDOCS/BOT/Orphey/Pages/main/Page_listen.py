...
def add_answer(app_from, user_id, data, id_query):
	...
	sqlighter.create_answer(token_user_query = token_user_query, id_query = id_query, token_user_answer = token_user_answer, answer = json.dumps(data, ensure_ascii=False))
	...
	sqlighter.set_user_data(app_from = app_from, user_id = user_id, line = 'data', data = json.dumps(data_page, ensure_ascii=False))
